...
1.  **Functional Test:** Validates the core logic (allocation, deallocation, re-use, and out-of-memory handling).
2.  **Benchmark Test:** Proves the "optimized latency" claim by running a high-stress, realistic benchmark.
...
**Conclusion:** In a realistic, high-stress scenario, this simple pool allocator is **over 6.8 times faster** than the standard system allocator, successfully demonstrating its value for high-performance code.
...
## 📁 Code Structure
  ...
  * **`main.cpp`**: A comprehensive test suite that validates correctness and benchmarks performance.
